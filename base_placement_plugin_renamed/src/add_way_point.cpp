...
AddWayPoint::AddWayPoint(QWidget* parent) : rviz::Panel(parent)  //, tf_()
{
  ...
  */
  ...
  server.reset(new interactive_markers::InteractiveMarkerServer("base_placement_plugin_renamed", "", false));
...
PLUGINLIB_EXPORT_CLASS(base_placement_plugin_renamed::AddWayPoint, rviz::Panel)
